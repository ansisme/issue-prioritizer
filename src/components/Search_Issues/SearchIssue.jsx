...
const SearchIssues = ({ onSearch }) => {
  ...
  return (
    ...
    <div className="ml-[31.5%] max-sm:ml-4 max-md:ml-[5%] max-lg:ml-[18%] max-xl:ml-[25%] align-center mt-20 flex-col">
      <div className="flex">
        <div className="flex">
        ...
        <input
          type="text"
          required={true}
          placeholder="Enter repository name who's issues you want to prioritize"
          value={repoName}
